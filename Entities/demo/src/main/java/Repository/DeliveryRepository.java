...
import Entity.Plant;
import Entity.RecipientAndPrice;
...
public class DeliveryRepository {
    ...
    public RecipientAndPrice getBill(Long deliveryId) {
        ...
        query.select(cb.construct(RecipientAndPrice.class, root.get("delivery").get("name"),
                cb.sum(root.get("price")))).where(cb.equal(root.get("delivery").get("id"), deliveryId));
